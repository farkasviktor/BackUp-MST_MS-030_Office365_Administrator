...
#   Update the emailAddress for 'Lara' to 'lara@XXXXXX.onmicrosoft.com'
#   Update the emailAddress for 'Logan' to 'Logan@XXXXXX.onmicrosoft.com'
#   Update the emailAddress for 'Holly' to “holly @XXXXXX.onmicrosoft.com”
...
If ($emailLara.emailAddress -notlike "Lara@XXXXXX.onmicrosoft.com"){
	Set-ADUser Lara -emailAddress Lara@XXXXXX.onmicrosoft.com
...
If ($emailLogan.emailAddress -notlike "Lara@XXXXXX.onmicrosoft.com"){
	Set-ADUser Logan -emailAddress Lara@XXXXXX.onmicrosoft.com
...
If ($emailHolly.emailAddress -notlike "holly @XXXXXX.onmicrosoft.com"){
	Set-ADUser Holly -emailAddress "holly @XXXXXX.onmicrosoft.com"
